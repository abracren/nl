...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_enqueue_script( 'jquery', 'https://code.jquery.com/jquery-2.1.1.min.js', array(), '2.1.0', false );
    ...
    wp_enqueue_script( 'foundation-js', '//cdn.foundation5.zurb.com/foundation.js', array( 'jquery' ), $theme_version, true );
