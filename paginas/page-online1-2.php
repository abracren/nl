					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div id="owl" class="owl-carousel" >
							...
							<div class="row">
							  <div class="small-12 medium-12 large-12 columns ">
							  	...
							  	<h3>Ver el video del Drill Nº 2.</h3>
							...
							<div class="row header_2">
							  	 <div  class="medium-7 columns">
							  	 	...
							  	 	<div class="flex-video widescreen videoFull ">
							  			        ...
							  			        <iframe width="560" height="315" src="//www.youtube.com/embed/E2g0wfkCHko?vq=hd1080" frameborder="0" allowfullscreen></iframe>
							  	...
							  	<div class="row panel videosPAnel1_1 ">
							  	  ...
							  	  <ul class="medium-block-grid-2">
							  		...
							  		<li class="">
									<h3>Foco 1</h3>
									<p class="overVideoPAr overVideoPArNoHeight2">Cabeza Alineada</p>
							  	  	<div class="flex-video widescreen videoFull ">
							  		
							  			        <iframe width="560" height="315" src="//www.youtube.com/embed/9qXoLgSwnPw?vq=hd1080" frameborder="0" allowfullscreen></iframe>
							  		...
							  		<li class="rightText">
									<h3>Foco 2</h3>
									<p class="overVideoPAr  overVideoPArNoHeight2">Haciendo bullir el agua.</p>
							  	  	<div class="flex-video widescreen videoFull ">
							  		
							  			        <iframe width="560" height="315" src="//www.youtube.com/embed/e0soSe6H728?vq=hd1080" frameborder="0" allowfullscreen></iframe>
							  		...
							  		<li class="">
									<h3>Foco 3</h3>
									<p class="overVideoPAr  overVideoPArNoHeight2">Brazos a lo largo del cuerpo.</p>
							  	  	<div class="flex-video widescreen videoFull ">
							  		...
							  		<li class="rightText">
									<h3>Foco 4</h3>
									<p class="overVideoPAr overVideoPArNoHeight2">Giro de los tobillos.</p>
							  	  	<div class="flex-video widescreen videoFull ">
							  		
							  			        <iframe width="560" height="315" src="//www.youtube.com/embed/lDhwADMMAqY?vq=hd1080" frameborder="0" allowfullscreen></iframe>
						...
						<div class="row">
							  <div class="small-12 medium-12 large-12 columns navigationCursoOnline">
							  	<div class="cursoPrev"><a href="/formacion-on-line/drill-1-equilibrio-ventral/">Anterior Lección</a></div>
							  <div class="cursoNext"><a href="/formacion-on-line/drill-3-activacion-del-balance-power-balance/">Siguiente Lección</a></div>
							  </div>
						</div>
						</div>
